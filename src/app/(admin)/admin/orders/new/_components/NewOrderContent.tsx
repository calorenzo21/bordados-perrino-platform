...
export default function NewOrderContent() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Revalidar caché del servidor (fire-and-forget — no bloquear la navegación)
      revalidateOrders().catch(console.error);
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Nuevo Pedido</h1>
      ...
      {/* Mensaje de error */}
      {error && (
        <div className="rounded-xl border border-red-200 bg-red-50 p-4 text-sm text-red-600 dark:border-red-800/50 dark:bg-red-900/20 dark:text-red-400">
          {error}
        </div>
      )}
      ...
      <div className="grid gap-6 lg:grid-cols-5">
        ...
        <div className="lg:col-span-2">
          <Card className="sticky top-6 overflow-hidden rounded-2xl border-0 pt-0 shadow-sm dark:bg-slate-800">
            ...
            <CardHeader className="pb-2 pt-12">
              <CardTitle className="flex items-center gap-2 text-base">
                ...
                <Badge
                  variant="outline"
                  className="border-blue-200 bg-blue-50 text-blue-600 dark:border-blue-800/50 dark:bg-blue-900/20 dark:text-blue-400"
                >
                  Requerido
                </Badge>
              </CardTitle>
            ...
            <CardContent className="space-y-4">
              ...
              <Button
                type="button"
                variant="ghost"
                className="h-9 w-full gap-2 rounded-xl text-blue-600 hover:bg-blue-50 hover:text-blue-700 dark:hover:bg-blue-900/20"
                onClick={handleOpenCreateClient}
              >
              ...
              {selectedClient && (
                <div className="animate-in fade-in slide-in-from-top-2 space-y-3 rounded-xl bg-slate-50 p-4 duration-300 dark:bg-slate-700/40">
                  <div className="flex items-center gap-3">
        ...
        <div className="lg:col-span-3">
          {/* Detalles del pedido */}
          <Card className="overflow-hidden rounded-2xl border-0 pt-0 shadow-sm dark:bg-slate-800">
            <CardHeader className="border-b border-slate-100 bg-slate-50/50 pt-6 dark:border-slate-700 dark:bg-slate-700/30">
              <CardTitle className="flex items-center gap-2 text-base">
            ...
            <CardContent className="grid gap-5 p-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="h-11 rounded-xl border-slate-200 transition-all focus:ring-2 focus:ring-blue-500/20 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100"
                />
              </div>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button
                        variant="outline"
                        className="h-11 w-full justify-between rounded-xl border-slate-200 dark:border-slate-600"
                      >
                        {formData.serviceType ||
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="h-11 rounded-xl border-slate-200 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100"
                  />
                </div>
              </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="h-11 rounded-xl border-slate-200 pl-7 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100"
                    />
                  </div>
                </div>
                <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full rounded-xl border border-slate-200 px-4 py-3 text-sm transition-all focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100 dark:placeholder:text-slate-500 dark:focus:border-blue-400"
                />
              </div>

              {/* Toggle Urgente */}
              <div
                className={`flex items-center justify-between rounded-xl border-2 p-4 transition-all ${formData.isUrgent ? 'border-rose-300 bg-rose-50 dark:border-rose-800/50 dark:bg-rose-900/20' : 'border-slate-200 bg-slate-50 dark:border-slate-600 dark:bg-slate-700/30'}`}
              >
                <div className="flex items-center gap-3">
                  <div
                    className={`flex h-10 w-10 items-center justify-center rounded-lg ${formData.isUrgent ? 'bg-rose-100 dark:bg-rose-900/30' : 'bg-slate-200 dark:bg-slate-600'}`}
                  >
                    <AlertTriangle
                  ...
                  <div>
                    <p
                      className={`font-medium ${formData.isUrgent ? 'text-rose-900 dark:text-rose-300' : 'text-slate-700 dark:text-slate-300'}`}
                    >
                      Pedido Urgente
                    </p>
                    <p
                      className={`text-xs ${formData.isUrgent ? 'text-rose-600 dark:text-rose-400' : 'text-slate-500 dark:text-slate-400'}`}
                    >
                      {formData.isUrgent
        ...
        <DialogContent className="max-w-lg rounded-2xl">
          ...
          {createdClientResult ? (
            <div className="space-y-4 py-2">
              <div className="rounded-xl border-2 border-emerald-200 bg-emerald-50 p-4 dark:border-emerald-800/50 dark:bg-emerald-900/20">
